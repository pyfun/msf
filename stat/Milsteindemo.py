...
"""
Solve the SDE. We define the f, g, and dg functions first, then pass them to
...
# numeric solutions
t, Xt = DiscreteBrownianMotion.sdeMilstein(f, g, dg, 1, dbm) 
# exact solutions
...
t2, Xt2  = DiscreteBrownianMotion.sdeMilstein(f, g, dg, 1, dbm2)  
...
try:
    ...
    for x, y in zip(Xt, Yt):
        gp.plot(Gnuplot.Data(t, x, with="lines", title="Milstein")) 
        gp.replot(Gnuplot.Data(t, y, with="lines", title="Exact")) 
        raw_input("press return to continue")
    
    for x2, y in zip(Xt2, Yt):
        gp.plot(Gnuplot.Data(t2, x2, with="linespoints", title="Milstein")) 
        gp.replot(Gnuplot.Data(t, y, with="lines", title="Exact")) 
        raw_input("press return to continue")
